...
<body>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex items-center mb-6 font-semibold text-white">
            <img class="w-25 h-12 mr-2" src="assets\img\ville.svg">    
        </a>
        <div class="w-full bg-gray-800 rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-xl font-bold leading-tight tracking-tight text-center text-gray-900 md:text-2xl dark:text-white">
                    Connectez-vous
                </h1>
                <form class="space-y-4 md:space-y-6" method="post" action="index.php?uc=connexion&action=valideConnexion">
                    <div>
            ...
            <!-- <a href="index.php?uc=creation&action=demandeCreation">Creer un compte</a> -->
        </div>
    </div>
