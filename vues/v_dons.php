...
<body>
  ...
  <div class="h-screen w-screen bg-gray-900 overflow-y-auto">
    ...
    <div class="text-white text-center p-6 ">
      <h1 class="text-xl font-serif p-6 ">Liste des dons </h1>
      ...
      <table class="w-full md:w-2/3 lg:w-1/2 text-sm sm:text-xs text-left rtl:text-right text-gray-300 dark:text-gray-400 mx-auto justify-center overflow-hidden rounded-lg">
        <thead class="text-xs sm:text-sm text-gray-400 uppercase bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Type Don</th>
            <th scope="col" class="px-6 py-3">A qui</th>
        ...
        <tbody>
            ...
            <?php 
                $lesDons = $pdo->getAllDons();
                $lesUsers = $pdo->getAllVictimeSansDons();
                foreach ($lesDons as $unDon) {
         
                  $uneVic = $pdo->getUneVictimeData($unDon->getIdPersonne());
                  $unDonnateur = $pdo->getUnDonateurById($unDon->getIdDonnateur());
                  $letype = $pdo->getLeTypeById($unDon->getTypeDon());
                 
                  echo "<tr class='border-t border-gray-700 bg-gray-800 dark:border-gray-700'>
                    
                    
                  <th scope='row' class='p-6 px-6 py-4 font-medium text-gray-300 whitespace-nowrap dark:text-white'>". $unDon->getDateDon()."</th>
                  <td class='px-6 py-4 text-center'>".$unDonnateur->getNom()."</td>
                  <td class='px-6 py-4'>".$unDonnateur->getPrenom()."</td>
                  <td class='px-6 py-4'>".$unDonnateur->getTypeDonnateur()."</td>
                  <td class='px-6 py-4'> ".$unDon->getMontantDons()."</td>
                  <td class='px-6 py-4'>".$unDonnateur->getNumTel()." </td>
                  <td class='px-6 py-4'>".$letype."</td>";
                  
               
                  if(!empty($uneVic)) {
                        
                    foreach($uneVic as $vic) {
                      echo "<td class='px-10 py-4'>".$vic->getNom()."- ".$vic->getPrenom()."</td>";
                    }
                  } else {
                      ...
                      "<td class='px-6 py-4'>
                      <a href='#' class=''>
                          <button data-modal-target='crud-modal' data-id='" . $unDon->getId() . "' data-modal-toggle='crud-modal' class='text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'>Attribuer</button>
                      </a>
                      </td>";
                  }
                    echo "
                  ...
                  <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form class="p-4 md:p-5" method="post" action="index.php?uc=modifier&action=validerAttribuerUser">
                          <div class="grid gap-4 mb-4 grid-cols-2 p-4">
                              
                              <div class="col-span-2 sm:col-span-1 hidden ">
                                <input value=<?php echo $unDon->getId()?> name="idaa" id="idaa" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                              </div>
                              
                              <div class="col-span-2">
                                  <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Personnes</label>
                                  <select id="category" name ="category2"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                      <?php 
                                        var_dump($lesUsers);
                                        foreach($lesUsers as $uneP) {
                                          echo "<option value=".$uneP->getId().">".$uneP->getPrenom()." - ".$uneP->getPrenom(). "</option>";
                                        }
                                      ?>
                          ...
                          <a href="" class="flex flex-col items-center p-6 ">
                            <button type="submit" class="text-white p-6 inline-flex items-center mt-2 mx-auto bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              Valider
                            </button>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative rounded-lg shadow bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-400 dark:text-gray-400">Voulez vous vraiment supprimer ce don ?</h3>
                                <a href ="index.php?uc=supprimer&action=validerSupprDon&id= <?php echo $unDon->getId()?>">
              ...
              ?>
                  ...
                  <div id="Add-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <form class="pl-4 pr-4 " method="post" action="index.php?uc=modifier&action=validerAjoutDon">
                          <div class="grid gap-4 mb-4 grid-cols-2 p-4">
                          <div class="col-span-2 ">
                                <label for="category1-add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Donateur</label>
                                <select id="category1-add" name ="category1-add"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                  ...
                                  foreach ($lesDonnateurs as $unDonateur) {
                                    echo "<option value=".$unDonateur->idDonnateur().">".$unDonateur->getNom()." - ".$unDonateur->getPrenom()."</option> ";
                                  }
                            ...
                            <div class="col-span-2">
                              <label for="date-add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                            ...
                            <div class="col-span-2">
                              <label for="montant-add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Montant</label>
                              <input type="number" name="montant-add" min="0" id="montant-add" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                            </div>
                            
                            <div class="col-span-2 ">
                                <label for="category2-add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type de don</label>
                                <select id="category2-add" name ="category2-add"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                  
                                  <?php 
                                  $lesTypes = $pdo->getAllType();
                                  foreach ($lesTypes as $unType) {
                                    echo "<option value=".$unType["idType"].">".$unType["nomType"]."</option> ";
                                  }
                          ...
                          <div class="col-span-2 ">
                                <label for="category3-add" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">A qui</label>
                                <select id="category3-add" name ="category3-add"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                  <option value="none">Aucune personne</option>
                                  <?php 
                                  $lesPersonnes = $pdo->getAllVictimeSansDons();
                                  foreach ($lesPersonnes as $unePersonne) {
                                    echo "<option value=".$unePersonne->getId().">".$unePersonne->getNom()." - ".$unePersonne->getPrenom()."</option> ";
                                  }
